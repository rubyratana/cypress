...
function indivMax(day) {
  ...
  cy.visit("https://cycle.dia-sandbox.govt.nz/cycle/5");
  ...
  cy.get("[id = individual-5-" + day + "]").type("10");
  cy.get("[type = submit]").click();
  cy.contains("retry");
}

context("Get to cycle 5", () => {
  beforeEach(() => {
  ...
  /*describe("Enter wrong input", () => {
    ...
    it("deny enter letter with number", () => {
      ...
      applyAllIndv("5", "1h");
      cy.get("[type = submit]").click();
      cy.contains("Total Household points: 35");
    });
  ...
  describe("Test calculations", () => {
    ...
    it("More than 30 per week indv 5", () => {
      applyAllIndv("5", "5");
      cy.get("[type = submit]").click();
      cy.contains("Total Household points: 30");
    });
    ...
    it("More than 30 per week both indv", () => {
      ...
      applyAllIndv("5", "5");
      cy.get("[type = submit]").click();
      cy.contains("Total Household points: 150");
    });
